...
### Gradle
```
implementation 'net.ravendb:ravendb:4.2.1'
```

## Documentation

Please find the official documentation on [RavenDB Documentation](https://ravendb.net/docs/article-page/4.1/java) page.
